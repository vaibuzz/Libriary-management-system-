...
class Library:
    ...
    def __init__(self, root):
        ...
        self.client = MongoClient("mongodb://localhost:27017")  # Modify with your MongoDB URI
        self.db = self.client['labriary']  # Replace 'library_db' with your desired database name
        self.collection = self.db['data']   # Replace 'books' with your desired collection name
        ...
        def DisplayData():
                data = {
                    ...
                    "PhoneNo": PhoneNo.get(),
                    "Author": Author.get(),
                    "DateofIssued": DateofIssued.get(),
                    "DueDate": DueDate.get(),
                    "ReturnFine": ReturnFine.get(),
                    "ReturnDate": ReturnDate.get(),
                    "Price": Price.get()
                }
                self.collection.insert_one(data)
                self.txtDisplayR.delete("1.0", END)
                self.txtDisplayR.insert(END, "Data inserted into MongoDB.\n")
        ...
        self.lblTitle = Label(TitleFrame, width=39, font=('Times New Roman', 40, 'bold'),
                              text="\tLibrary Management System\t", bg="cadetblue", fg='Crimson', padx=12)
        self.lblTitle.grid()
        ...
        DataFrameLEFT = LabelFrame(DataFrame, bd=10, width=900, height=300, padx=20, relief=RIDGE,
                                   font=('Times New Roman', 12, 'bold'), text="Library Membership Info:",
                                   fg="cadetblue")
        DataFrameLEFT.pack(side=LEFT)

        DataFrameRIGHT = LabelFrame(DataFrame, bd=10, width=450, height=300, padx=20, relief=RIDGE,
                                    font=('Times New Roman', 12, 'bold'), text="BookDetails", fg="Crimson")
        ...
        '--select--', 'Student', 'Lecturer', 'AdminStaff', 'MembershipNo', 'Purchase Id', 'AadharCardNo',
        ...
        # =======================================Widget=================================================================
        self.txtDisplayR = Text(DataFrameRIGHT, font=('Times New Roman', 12, 'bold'), width=32, height=13, padx=8,
                                pady=20)
        self.txtDisplayR.grid(row=0, column=2)
        # ======================================ListBox==================================================================

        ListofBooks = ['Clinderella', 'Game Design', 'Programming in C', 'Ancient Rome', 'Made in Africa',
                       'Dr.B.R.Ambedkar', 'London', 'Hello India', 'PythonDeveloper']
        ...
        # =======================================Button=========================================================================
        self.btnDisplayData = Button(ButtonFrame, text="DISPLAYDATA", fg="Crimson", bg="cadetblue",
                                     font=('Times New Roman', 12, 'bold'), width=30, bd=4, command=DisplayData)
        self.btnDisplayData.grid(row=0, column=0)

        self.btnDelete = Button(ButtonFrame, text="DELETE", fg="Crimson", bg="cadetblue",
                                font=('Times New Roman', 12, 'bold'), width=30, bd=4, command=Delete)
        self.btnDelete.grid(row=0, column=1)

        self.btnReset = Button(ButtonFrame, text="RESET", fg="Crimson", bg="cadetblue",
                               font=('Times New Roman', 12, 'bold'), width=30, bd=4, command=Reset)
        self.btnReset.grid(row=0, column=2)

        self.btnExit = Button(ButtonFrame, text="EXIT", fg="Crimson", bg="cadetblue",
